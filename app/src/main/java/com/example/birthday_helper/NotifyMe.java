...
import static com.example.birthday_helper.Notification.NotificationEntry.NOTIFICATION_ACTIONS;
import static com.example.birthday_helper.Notification.NotificationEntry.NOTIFICATION_ACTIONS_COLLAPSE;
import static com.example.birthday_helper.Notification.NotificationEntry.NOTIFICATION_ACTIONS_DISMISS;
import static com.example.birthday_helper.Notification.NotificationEntry.NOTIFICATION_ACTIONS_TEXT;
import static com.example.birthday_helper.Notification.NotificationEntry.NOTIFICATION_COLOR;
import static com.example.birthday_helper.Notification.NotificationEntry.NOTIFICATION_CONTENT_TEXT;
import static com.example.birthday_helper.Notification.NotificationEntry.NOTIFICATION_CUSTOM_ID;
import static com.example.birthday_helper.Notification.NotificationEntry.NOTIFICATION_LARGE_ICON;
import static com.example.birthday_helper.Notification.NotificationEntry.NOTIFICATION_LED_COLOR;
import static com.example.birthday_helper.Notification.NotificationEntry.NOTIFICATION_SMALL_ICON;
import static com.example.birthday_helper.Notification.NotificationEntry.NOTIFICATION_TIME;
import static com.example.birthday_helper.Notification.NotificationEntry.NOTIFICATION_TITLE_TEXT;
...
public class NotifyMe {
  ...
  protected NotifyMe(Builder builder){
    ...
    com.example.birthday_helper.Notification.NotificationDBHelper mDbHelper = new com.example.birthday_helper.Notification.NotificationDBHelper(builder.context);
    ...
    long id = db.insert(com.example.birthday_helper.Notification.NotificationEntry.TABLE_NAME,null,values);
    db.close();
  ...
  public static void cancel(Context context,String key){
    try {
      ...
      com.example.birthday_helper.Notification.NotificationDBHelper mDbHelper = new com.example.birthday_helper.Notification.NotificationDBHelper(context);
      SQLiteDatabase db = mDbHelper.getWritableDatabase();
      Cursor cursor = db.rawQuery("SELECT * FROM " + com.example.birthday_helper.Notification.NotificationEntry.TABLE_NAME + " WHERE custom_id = ? LIMIT 1", new String[]{key});
      cursor.moveToFirst();
      int notificationId = cursor.getInt(cursor.getColumnIndex(com.example.birthday_helper.Notification.NotificationEntry._ID));
      db.delete(TABLE_NAME, com.example.birthday_helper.Notification.NotificationEntry._ID + " = " + notificationId, null);
      db.close();
      cursor.close();
      mNotificationManager.cancel(notificationId);
  ...
  public static void init(Context context){
    com.example.birthday_helper.Notification.NotificationDBHelper mDbHelper = new com.example.birthday_helper.Notification.NotificationDBHelper(context);
    SQLiteDatabase db = mDbHelper.getWritableDatabase();
    Cursor cursor = db.rawQuery("SELECT * FROM "+com.example.birthday_helper.Notification.NotificationEntry.TABLE_NAME+" WHERE 1=1",null);
    while(cursor.moveToNext()){
      Long time = cursor.getLong(cursor.getColumnIndex(NOTIFICATION_TIME));
      int id = cursor.getInt(cursor.getColumnIndex(com.example.birthday_helper.Notification.NotificationEntry._ID));
