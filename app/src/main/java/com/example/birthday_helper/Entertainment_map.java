...
public class Entertainment_map extends FragmentActivity implements
    ...
    public void onClick(View v){
        String restaurant = "restaurant", Shopping_mall = "Shopping mall", hotel = "hotel",
                Movie_theater = "Movie theater", Amusement_park = "Amusement park";
        ...
        switch(v.getId()){
            case R.id.search_address:
                ...
                if(!TextUtils.isEmpty(address)){
                    ...
                    Toast.makeText(this, "Please write your choice of location...", Toast.LENGTH_SHORT).show();
                }
                break;
            ...
            case R.id.hotels_nearby:
                mMap.clear();
                url = getUrl(latitude, longtitude, hotel);
                transferData[0] = mMap;
                transferData[1] = url;
    ...
    // check for permission request granted or denied case
    @Override
    ...
    @Override
    public void onLocationChanged(Location location) { // Location listener
